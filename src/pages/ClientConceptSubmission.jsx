...
const ClientConceptSubmission = () => (
  <div className="relative flex min-h-screen w-full flex-col justify-between overflow-x-hidden bg-[#111422]" style={{ fontFamily: '"Space Grotesk", "Noto Sans", sans-serif' }}>
    <div>
      ...
      <div className="flex flex-col p-4">
        <div className="flex flex-col items-center gap-6 rounded-lg border-2 border-dashed border-[#323b67] px-6 py-14">
          <div className="flex max-w-[480px] flex-col items-center gap-2">
            ...
            <p className="max-w-[480px] text-center text-sm font-normal leading-normal text-white">Upload images, documents, or other files related to your concept.</p>
          </div>
