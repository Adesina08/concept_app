        ...
        {[
          {
            ...
            due: 'Due: July 15',
            image:
              'https://lh3.googleusercontent.com/aida-public/AB6AXuAhi9fgjonLHpZNu9FINuY3gYyYWJbDN0m1CFpPVJA68_wWZc8eCqR4vOCzX5sPniukmrLemH4DX3gIrNXoVRdFsbApHNd9O5I7kl1riZH7niQJSIl0k9gnCzZwUzIuLX3lzM-IpKg4NBYv_TOrLztMLb8H1FXgUaRVMEntQVqe8xRINItOvrlGkPbMrmH3_EhcWiaQh4HV3WSJIKYu2kPOFryDlfmw1ai_vC9xtOU1Q5SoEwZ_XryTBAXUBCsFkm9LowPcJErUVlYQ',
          },
          {
            title: 'Concept B',
            due: 'Due: July 20',
            image:
              'https://lh3.googleusercontent.com/aida-public/AB6AXuBZ1aLaul269tLJq-JFaK-Es1PkJuYzpzMPjDKIML1pGENGJrbbWhtatpbtNByeZqx9dmtZ4a1BaLsXBX5efvs1yqiSiEjPQwqEOqrTblYy4nYTY8rpLmFKQ5Pegsl-83Yh_oAs6E3FGzElwUOciY71jLNzX4M-A1kPgaly-9QSHacpVXPMQWeP9u84Qzia96Cx4FaL3JCWytBGnHFzGtUA-4YkMYlQzSOCnEoMNkpUsuGepDAYGb6gzKHjnuUPf_sVmDsFCIinnZgG',
          },
        ].map((item) => (
          <div key={item.title} className="flex min-h-[72px] items-center gap-4 bg-[#111422] px-4 py-2">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="line-clamp-2 text-sm font-normal leading-normal text-[#929bc9]">{item.due}</p>
            </div>
          </div>
        ))}
      </div>
